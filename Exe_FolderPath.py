...
if __name__ == "__main__":
    ...
    #names = ['Aadhaar (IND)', 'American Express', 'CanaraBankLOGO', 'Diners Club', 'Discover', 'Driving License', 'Passport', 'JCB', 'KA_DL_Back', 'Maestro', 'Master Card', 'NINO (UK)', 'NRIC (Singapore)', 'National ID (Saudi Arabia)', 'National ID (UAE)', 'PAN (IND)', 'RuPay', 'SSN (US)', 'Union Pay', 'VISA', 'Voter ID (IND)']
